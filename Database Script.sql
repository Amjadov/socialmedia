...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2020 at 11:27 AM
...
CREATE TABLE `socialmedia` (
  ...
  `result_data` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `uploadedfile` (
  ...
  `realpath` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `memetype` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `savedestination` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `savedname` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
